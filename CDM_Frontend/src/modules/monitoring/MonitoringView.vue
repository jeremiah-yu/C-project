...
import { fetchEarlyWarnings, fetchMyRisk, generateSupportPlan } from './services/monitoringApi'
...
const load = async () => {
  ...
  try {
    overview.value = isStudent.value ? await fetchMyRisk() : await fetchEarlyWarnings()
...
<template>
  <section class="page-header">
    ...
    <h1 class="page-title">Early Warning System</h1>
    <p class="page-description">
      Grade trends are scored for risk of failing. Open a student to review warnings and generate a help-support plan.
    </p>
  </section>
